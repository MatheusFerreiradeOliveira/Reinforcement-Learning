...
class Car(Widget):
    ...
    def move(self, rotation):
        ...
        self.signal1 = int(np.sum(sand[int(self.sensor1_x)-20:int(self.sensor1_x)+20, int(self.sensor1_y)-20:int(self.sensor1_y)+20]))/400. # calcula o sinal recebido do sensor 1 (densidade de areia ao redor do sensor 1)
        self.signal2 = int(np.sum(sand[int(self.sensor2_x)-20:int(self.sensor2_x)+20, int(self.sensor2_y)-20:int(self.sensor2_y)+20]))/400. # calcula o sinal recebido do sensor 1 (densidade de areia ao redor do sensor 2)
        self.signal3 = int(np.sum(sand[int(self.sensor3_x)-20:int(self.sensor3_x)+20, int(self.sensor3_y)-20:int(self.sensor3_y)+20]))/400. # calcula o sinal recebido do sensor 1 (densidade de areia ao redor do sensor 3)
        if self.sensor1_x>longueur-20 or self.sensor1_x<20 or self.sensor1_y>largeur-20 or self.sensor1_y<20: # se o sensor 1 saiu do mapa
            self.signal1 = 1. # sensor 1 detecta areia
        if self.sensor2_x>longueur-20 or self.sensor2_x<20 or self.sensor2_y>largeur-20 or self.sensor2_y<20: # se o sensor 2 saiu do mapa
            self.signal2 = 1. # sensor 2 detecta areia
        if self.sensor3_x>longueur-20 or self.sensor3_x<20 or self.sensor3_y>largeur-20 or self.sensor3_y<20: # se o sensor 3 saiu do mapa
